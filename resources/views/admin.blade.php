            ...
            <div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Companies</span> </a>
							<ul>
								<li><a class="submenu" href="{{ route('create') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> create</span></a></li>
								<li><a class="submenu" href="{{ route('allcat') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Category</span></a></li>
								{{--  <li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Sub Menu 3</span></a></li>  --}}
							</ul>

                            <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Employees</span> </a>

                            <ul>
								<li><a class="submenu" href="{{ route('em.create') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> create</span></a></li>
								<li><a class="submenu" href="{{ route('employe.allcat') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Category</span></a></li>
								{{--  <li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Sub Menu 3</span></a></li>  --}}
							</ul>
						</li>
						{{--  <li><a href="{{route('create')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Companies</span></a></li>  --}}
                        {{--  {{route('dashboard')}}  --}}
